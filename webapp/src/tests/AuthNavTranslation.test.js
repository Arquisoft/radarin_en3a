...
test('check that language is changing', async () => {
  ...
  expect(c.getAllByText(i18n.getDataByLanguage('en').translation.navBarProfile)).toBeDefined(); 
  ...
  expect(c.getAllByText(i18n.getDataByLanguage('es').translation.navBarProfile)).toBeDefined(); 
